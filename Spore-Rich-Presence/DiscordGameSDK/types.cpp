...
{
    safe_strcpy(internal_.username, username, 256);
...
{
    safe_strcpy(internal_.discriminator, discriminator, 8);
...
{
    safe_strcpy(internal_.avatar, avatar, 128);
...
{
    safe_strcpy(internal_.access_token, accessToken, 128);
...
{
    safe_strcpy(internal_.scopes, scopes, 1024);
...
{
    safe_strcpy(internal_.large_image, largeImage, 128);
...
{
    safe_strcpy(internal_.large_text, largeText, 128);
...
{
    safe_strcpy(internal_.small_image, smallImage, 128);
...
{
    safe_strcpy(internal_.small_text, smallText, 128);
...
{
    safe_strcpy(internal_.id, id, 128);
...
{
    safe_strcpy(internal_.match, match, 128);
...
{
    safe_strcpy(internal_.join, join, 128);
...
{
    safe_strcpy(internal_.spectate, spectate, 128);
...
{
    safe_strcpy(internal_.name, name, 128);
...
{
    safe_strcpy(internal_.state, state, 128);
...
{
    safe_strcpy(internal_.details, details, 128);
...
{
    safe_strcpy(internal_.secret, secret, 128);
...
{
    safe_strcpy(internal_.filename, filename, 260);
...
{
    safe_strcpy(internal_.currency, currency, 16);
...
{
    safe_strcpy(internal_.name, name, 256);
...
{
    safe_strcpy(internal_.shortcut, shortcut, 256);
...
{
    safe_strcpy(internal_.unlocked_at, unlockedAt, 64);
